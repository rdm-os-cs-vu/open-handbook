...
subtitle: version v0.6, February 19, 2026
authors:
- name: Kees Verstoep
...
This guideline makes concrete suggestions for our department based on the 2024
university [RDSM policy](https://rdm.vu.nl/topics/research-data-and-software-management-policy.html)
...
|                                  |   using that instead.                               |
|                                  | - Use of this service has been restricted to only   |
|                                  |   limited use cases since July 1, 2025.             |
+----------------------------------+-----------------------------------------------------+
+----------------------------------+-----------------------------------------------------+
...
***Also note that SURFdrive hase been restricted to limited use cases at the VU since 1 July 2025***
...
If none of the options satisfy your requirements, a custom setup or configuration may be possible. Contact the University RDM Support Desk (rdm@vu.nl) or the department RDM contact Kees Verstoep (c.verstoep@vu.nl) to explore the options.
