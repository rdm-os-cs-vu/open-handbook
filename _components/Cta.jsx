function Cta() {
  return (
    ...
    <div>
      <div>
          <p><b>Shuai Wang </b>(Deptartment Data Steward): shuai.wang@vu.nl</p>
          <p><b>Kees Verstoep </b>(Deptartment Data Steward): c.verstoep@vu.nl</p>
          <p><b>Brett Olivier </b>(Faculty Data Steward): rdm.beta@vu.nl</p>
      </div>
    </div>

    <h3 className="tw-mx-auto tw-mt-6 tw-max-w-xl tw-text-lg tw-leading-8 tw-text-sky-200" >Other Contacts</h3>
